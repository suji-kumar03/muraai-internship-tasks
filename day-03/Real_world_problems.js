...
//2. Shopping Cart — Array Destructuring
const cart = [
    "Laptop",
    "Mouse",
    "Keyboard",
...
//4. Spread Operator Combine Skills
...
console.log(`Full Stack Skills: ${fullStackSkills.join(", ")}`);//8.Update Employee Details(spread operator)
const newemployee = {
    name: "John",
    department: "IT",
    salary: 50000
...
//Rest Operator 6. Calculate Total Order Amount
function calculateTotal(...numbers) {
    return numbers.reduce((total, num) => { return total + num }, 0);
}
console.log(calculateTotal(100, 200, 300, 400, 500));
//7.Send Notification to Multiple Users =>map= manipulate or change the existing array
...
//Default Parameters 8. Create Employee -->position should be same
